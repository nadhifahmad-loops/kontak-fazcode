...
document.addEventListener("DOMContentLoaded", function() {
  ...
  function updateAnimations() {
    ...
    if (width <= 426) {
        ...
        gsap.to("#foto3", { width: "10%", left: "35%", top: "210%" });
        gsap.to("#foto4", { width: "20%", top: "225%", left: "41%" });
    }
}
...
function toggleVisibility() {
    const dropdown = document.getElementById("cntr-nav2");
    if (dropdown.classList.contains("hidden")) {
        dropdown.classList.remove("hidden");
        dropdown.style.display = "block"; // Menambahkan style display: block saat menghapus kelas hidden
    } else {
